...
class SchoolBuyerScreenUpdate extends StatefulWidget {
  const SchoolBuyerScreenUpdate({Key? key}) : super(key: key);

  @override
  State<SchoolBuyerScreenUpdate> createState() => _SchoolBuyerScreenUpdateState();
}
...
class _SchoolBuyerScreenUpdateState extends State<SchoolBuyerScreenUpdate> {
  @override
