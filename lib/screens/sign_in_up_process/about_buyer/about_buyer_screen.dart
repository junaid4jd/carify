    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => const FeaturesBuyer()));
          },
        ),
      ),
      body: Column(
        ...
        children: <Widget>[
          ...
          ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const ProfilePicBuyer()),
                );
              }),
        ],
      ),
